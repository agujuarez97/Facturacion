...
public class ing_brutosExistente extends javax.swing.JFrame {
    
    public ing_brutosExistente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INGRESOS BRUTOS EXISTENTE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ing_brutosExistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ing_brutosExistente().setVisible(true);
            }
        });
    }
