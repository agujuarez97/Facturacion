 ...
 * @author matias
 */
public class UsuarioNoReg extends javax.swing.JFrame {

    /**
     * Creates new form UsuarionoReg
     */
    public UsuarioNoReg() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuarioNoReg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuarioNoReg().setVisible(true);
            }
        });
    }
