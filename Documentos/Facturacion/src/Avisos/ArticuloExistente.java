...
public class ArticuloExistente extends javax.swing.JFrame {

    /**
     * Creates new form AvisoArticulo
     */
    public ArticuloExistente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ARTICULO EXISTENTE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArticuloExistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArticuloExistente().setVisible(true);
            }
        });
    }
