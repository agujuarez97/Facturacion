 ...
 * @author matias
 */
public class MovimientoCantidad extends javax.swing.JFrame {

    /**
     * Creates new form AvisoMovimientoCantidad
     */
    public MovimientoCantidad() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CANTIDAD INVALIDA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MovimientoCantidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MovimientoCantidad().setVisible(true);
            }
        });
    }
